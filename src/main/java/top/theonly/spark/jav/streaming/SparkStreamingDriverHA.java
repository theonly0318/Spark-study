...
/**
 * Driver HA（Standalone或者Mesos）     只适用于业务逻辑（代码）一成不变的 SparkStreaming程序
 ...
 *
 */
public class SparkStreamingDriverHA {

    /** checkpoint目录 */
    private static final String CHECKPOINT_DIR = "./data/streaming/driver_ha_ck";
    ...
    public static void main(String[] args) throws InterruptedException {
         ...
         */
        JavaStreamingContext streamingContext = JavaStreamingContext.getOrCreate(CHECKPOINT_DIR, new Function0<JavaStreamingContext>() {
            @Override
    ...
    public static JavaStreamingContext createStreamingContext() {
        ...
        JavaPairDStream<String, Integer> pairMapDS =
                streamingContext.socketTextStream("node0", 9999)
        ...
        /**
         * 当Driver down掉后，重启，新的代码逻辑是不会执行的
         * 如果想要执行：1、删除checkpoint目录  2、重启时重新指定checkpoint目录
         *          这样的话job的历史执行进度就会没有，因此DriverHA 不适用于会修改（代码）业务逻辑的SparkStreaming程序
         */
        // 新的逻辑
