 ...
 * 方差归一化
 */
object LogisticRegressionTest6 {

  def main(args: Array[String]) {
    val conf = new SparkConf().setAppName("LogisticRegression6").setMaster("local[3]")
     ...
     *
     */
    val inputData = MLUtils.loadLibSVMFile(sc, "./data/MLlib/环境分类数据.txt")
